...
export default function LiveModePage() {
  ...
  type LanguageCode = "english" | "hindi" | "telugu"

  const getSelectedLanguage = (): LanguageCode => {
    try {
      const stored = localStorage.getItem("trinera_language") as LanguageCode | null
      if (stored === "english" || stored === "hindi" || stored === "telugu") return stored
    } catch {
  ...
  const getRecognitionLang = (lang: LanguageCode) => {
  ...
  const initializeSpeechRecognition = useCallback(() => {
    ...
    recognition.lang = getRecognitionLang(getSelectedLanguage())
                ...
                <div className="text-center">
                  <div className="text-white font-bold text-xl mb-2">
                    {getSelectedLanguage() === "english"
                      ? "Analyzing Pest..."
                      : getSelectedLanguage() === "hindi"
                        ? "कीट का विश्लेषण हो रहा है..."
                        : "పురుగును విశ్లేషిస్తున్నాము..."}
                  </div>
